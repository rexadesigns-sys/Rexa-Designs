...
('Saman Kumara', 'Rexa Designs transformed our brand identity. The logo they created perfectly captures our values.', 5),
('Nisansala Perera', 'Highly professional service. They delivered our social media templates ahead of schedule and they look amazing.', 5),
('Roshan Silva', 'We have been working with Rexa Designs for over two years now. Exceptional quality and communication.', 5);

-- Seed Portfolio Projects
INSERT INTO portfolio (title, category, img, "desc", gallery, hide_from_portfolio) VALUES
