...
const socialLinks = [
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/share/1HszL2hZgy/',
    icon: (
      <SocialIcon>
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/rexa_designs_official?igsh=MTZyOXZrZm9nenEwbQ==',
    icon: (
      <SocialIcon>
  ...
  {
    label: 'TikTok',
    href: 'https://www.tiktok.com/@rexa_designs?_r=1&_t=ZS-95r5IZz4p7v',
    icon: (
      <SocialIcon>
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@RexaDesigns',
    icon: (
      <SocialIcon>
  ...
  {
    label: 'Pinterest',
    href: 'https://www.pinterest.com/rexadesigns/',
    icon: (
      <SocialIcon>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-14 lg:mb-16">
          <div>
            ...
            <p className="text-sm text-gray-400 mb-6">
              Professional graphic solutions with 5+ years of experience.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400 flex flex-col">
              <li>Registered Address: 429/C, Angampitiya,Padukka</li>
              <li>
                <Link href="/contact" className="hover:text-orange-500 transition-colors">
                  rexadesigns@gmail.com
                </Link>
              </li>
              <li>+9475 762 2259</li>
            </ul>
